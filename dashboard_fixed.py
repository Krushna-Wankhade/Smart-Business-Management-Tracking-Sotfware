...
class IMS:
    def __init__(self,root):
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="_",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#-------------- functions ----------------
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_clock.config(text=f"_\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
